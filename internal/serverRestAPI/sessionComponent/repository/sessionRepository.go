...
func (assr *authSessionServiceRepository) SessionExists(ctx context.Context, session *models.Session) (bool, error) {
	...
	exists, err := assr.authSessionServiceClient.SessionExists(grpcUtils.UpgradeContextByInjectedMetadata(ctx), &authSessionServiceGrpcProtos.Session{
...
func (assr *authSessionServiceRepository) CreateSessionForUser(ctx context.Context, email string, password string) (*models.Session, error) {
	...
	session, err := assr.authSessionServiceClient.CreateSessionForUser(grpcUtils.UpgradeContextByInjectedMetadata(ctx), &authSessionServiceGrpcProtos.UserAccountData{
		Email:    email,
		Password: password,
	})
	if err != nil {
...
func (assr *authSessionServiceRepository) RemoveSession(ctx context.Context, session *models.Session) error {
	...
	_, err := assr.authSessionServiceClient.RemoveSession(grpcUtils.UpgradeContextByInjectedMetadata(ctx), &authSessionServiceGrpcProtos.Session{
		SessionId: session.SessionId,
	})
	if err != nil {
		assr.logger.LogrusLoggerWithContext(ctx).Warn(err)
...
func (assr *authSessionServiceRepository) GetUserInfoBySession(ctx context.Context, session *models.Session) (*models.User, error) {
	...
	userInfo, err := assr.authSessionServiceClient.GetUserInfoBySession(grpcUtils.UpgradeContextByInjectedMetadata(ctx), &authSessionServiceGrpcProtos.Session{
		SessionId: session.SessionId,
	})
	if err != nil {
		assr.logger.LogrusLoggerWithContext(ctx).Warn(err)
...
func (assr *authSessionServiceRepository) GetUserEmailBySession(ctx context.Context, session *models.Session) (string, error) {
	...
	userEmail, err := assr.authSessionServiceClient.GetUserEmailBySession(grpcUtils.UpgradeContextByInjectedMetadata(ctx), &authSessionServiceGrpcProtos.Session{
		SessionId: session.SessionId,
	})
	if err != nil {
		assr.logger.LogrusLoggerWithContext(ctx).Warn(err)
