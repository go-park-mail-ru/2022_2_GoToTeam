...
GRANT UPDATE ON subscriptions, articles, articles_likes, users_categories_subscriptions, comments, comments_likes, tags_articles to :user_name;
GRANT DELETE ON subscriptions, articles, articles_likes, users_categories_subscriptions, comments, comments_likes, tags_articles to :user_name;
